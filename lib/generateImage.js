...
async function generateImage() {
  ...
  try {
    ...
    console.log(`[${new Date().toISOString()}] Waiting for app to hydrate...`);
    await page.waitForFunction(() => window.__APP_HYDRATED__ === true, { timeout: 30000 });

    console.log(`[${new Date().toISOString()}] App hydrated - waiting for charts to render...`);
